	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(a.equals(Vista.btnAceptarNuevo))
		{
			try
			{
				...
				Modelo.sentencia = "INSERT INTO empleados (nombreEmpleado) VALUES ('" + Vista.txtNombreEmpleado.getText()+ "')";
		...
		else if(a.equals(Vista.mnConsultar))
		{
			...
			try
			{
				...
				while(Modelo.rs.next())
				{
					...
					{
						Vista.areaConsulta.setText(Modelo.rs.getInt("idEmpleado")+
		...
		else if(a.equals(Vista.mnEliminar))
		{
			...
			try
			{
				...
				while(Modelo.rs.next())
				{
					String s=Integer.toString(Modelo.rs.getInt("idEmpleado"));s = s + "-"+ Modelo.rs.getString("nombreEmpleado");Vista.choEliminarEmpleado.add(s);
				}
			}
			catch (ClassNotFoundException cnfe)
			{
		...
		else if(a.equals(Vista.mnModificar))
		{
			...
			try
			{
				...
				while(Modelo.rs.next())
				{
					String s=Integer.toString(Modelo.rs.getInt("idEmpleado"));s = s + "-"+ Modelo.rs.getString("nombreEmpleado");
		...
		else if(a.equals(Vista.btnConfirmarMod))
		{
			...
			try
			{
				...
				Modelo.connection = DriverManager.getConnection(Modelo.url, Modelo.usuario, Modelo.clave);
				Modelo.statement = Modelo.connection.createStatement();
				Modelo.sentencia = "UPDATE empleados SET nombreEmpleado = '"+nombre+"' WHERE idEmpleado="+idEmpleado;
				Modelo.statement.executeUpdate(Modelo.sentencia);
